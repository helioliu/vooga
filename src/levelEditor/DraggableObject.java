	...
	private void addMouseListener() {
		...
		addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				int newX = (int) (32*( Math.round(((double) (mouseOnScreen.x - parentOnScreen.x -anchorX)) / 32.0)));
				int newY = (int) (32*( Math.round(((double) (mouseOnScreen.y - parentOnScreen.y -anchorY)) / 32.0)));
