...
public class InputManager implements BaseInput {
        ...
        /**
         * Creates new {@link InputManager} from specified component.
         * @param comp The component to create a {@link InputManager} for.
         */
...
//                	currentlyPressed.add(KeyEvent.getKeyText(e.getKeyCode()));
                        ...
                        if (!InputManager.this.keyDown[e.getKeyCode() & 0xFF]) {
                                InputManager.this.keyDown[e.getKeyCode() & 0xFF] = true;
                                
                                InputManager.this.keyPressed[InputManager.this.pressedKey] = e
                                        .getKeyCode();
                                InputManager.this.pressedKey++;
                        }
...
//                		currentlyPressed.remove(KeyEvent.getKeyText(e.getKeyCode()));
                ...
                public void mouseEntered(MouseEvent e) {
                        InputManager.this.mouseExists = true;
                }
                
                public void mouseExited(MouseEvent e) {
                        InputManager.this.mouseExists = false;
                        
                        for (int i = 0; i < 4; i++) {
                                InputManager.this.mouseDown[i] = false;
                        }
                }
                
                public void mousePressed(MouseEvent e) {
                        InputManager.this.mouseDown[e.getButton()] = true;
                        
                        InputManager.this.mousePressed[InputManager.this.pressedMouse] = e
                                .getButton();
                        InputManager.this.pressedMouse++;
                }
                
                public void mouseReleased(MouseEvent e) {
                        InputManager.this.mouseDown[e.getButton()] = false;
                        
                        InputManager.this.mouseReleased[InputManager.this.releasedMouse] = e
                                .getButton();
                        InputManager.this.releasedMouse++;
                }
                
                // ///////// MouseMotionListener ///////////
                public void mouseDragged(MouseEvent e) {
                        InputManager.this.mouseX = e.getX();
                        InputManager.this.mouseY = e.getY();
                }
