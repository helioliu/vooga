...
public class PlatformGame extends Game{
    ...
    public void initResources() {
        ...
        boss = new BossSprite(getImages("images/bau5.png", 1, 5), 400, 100, getImage("images/pewpewpew.png"), s1, projectiles);
        HUD = new HeadsUpDisplay(0, 0);
        FollowGraphicItem healthBar = new FollowGraphicItem(getImage("images/healthbar2.png", false), 110, 60, boss.getStat("health"), boss);
    ...
    public void update(long elapsedTime) {
        ...
        if( boss.getStat("health").getValue()<300){
            EventManager.getEventManager().sendEvent("get angry");
        }
